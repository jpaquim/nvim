...
local defaults = {
  ...
  defaults = {
    autocmds = true,
    keymaps = true,
    -- options can't be configured here since that's loaded before lazyvim setup
    -- if you want to disable loading options, add `package.loaded["options"] = true` to the top of your init.lua
  },
